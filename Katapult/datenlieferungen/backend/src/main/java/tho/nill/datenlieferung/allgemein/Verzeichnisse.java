...
public class Verzeichnisse {
	private String datenPathOriginal = "build/original";
	private String datenPathVerschl = "build/verschl";
	...
	public static String getTestVerz(Object source, String verz) {
		String testVerzName = "build" + "/" + "daten" + "/" + source.getClass().getSimpleName() + "/" + verz;
		try {
