...
public class KasseEntityController  {
    ...
    , @RequestParam(name = "kommunikationskanal") String kommunikationskanal
     // value
    		...
    		try {
    			Kasse d = service.create(ik, art, funktion, firma, plz, ort, straße, email, gültigAb, gültigBis, iban, bic, kontoinhaber, name, name2, name3, name4, ansprechpartner, telefon, fax, arbeitsgebiet, medium, parameter, zeichensatz, komprimierung, protokoll, benutzerkennung, übertragung_von, übertragung_bis, übertragungstage, kommunikationskanal);
    	...
    	public String update(@PathVariable(name = "id") long id,
    		...
    		try {
    			service.update(id,ik, art, funktion, firma, plz, ort, straße, email, gültigAb, gültigBis, iban, bic, kontoinhaber, name, name2, name3, name4, ansprechpartner, telefon, fax, arbeitsgebiet, medium, parameter, zeichensatz, komprimierung, protokoll, benutzerkennung, übertragung_von, übertragung_bis, übertragungstage, kommunikationskanal);
